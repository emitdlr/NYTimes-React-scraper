			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						' A React based module to search for New York Times articles, save articles and comment on articles. '
					)
				),
				React.createElement(
					'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Query = __webpack_require__(233);
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									'h1',
									{ className: 'lead' },
									React.createElement('span', { 'class': 'glyphicon glyphicon-search' }),
									'  Search Query'
								)
							),
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement('input', { type: 'text', value: this.state.value, className: 'form-control', id: 'term', onChange: this.handleChange, required: true })
									),
									React.createElement(
										'div',
										{ className: 'form-group' },
									...
									React.createElement(
										...
										React.createElement('input', { type: 'text', value: this.state.value, className: 'form-control', id: 'end', onChange: this.handleChange, required: true })
									),
									React.createElement(
										'button',
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										null,
										' ',
										React.createElement('span', { 'class': 'glyphicon glyphicon-list-alt', 'aria-hidden': 'true' }),
										' Results '
									)
								)
							),
